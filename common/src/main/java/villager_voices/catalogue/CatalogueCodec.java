 ...
 * with a {@code "subtitle"} string and a {@code "sound"} string.
 */
public final class CatalogueCodec {
     ...
     *     or names a different event than {@code eventId}, or {@code soundExists} rejects an id
     */
    public static List<Line> parseEventFile(String eventId, String json, Predicate<String> soundExists) {
        ...
        for (Object entry : list) {
            ...
            lines.add(new Line(subtitle, soundId));
        }
