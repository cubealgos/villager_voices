...
| `villager_voices.fabric.events` | fabric | PolledEvents |  |
| `villager_voices.fabric` | fabric (test) | SourceSurfaceTest |  |
| `villager_voices.fabric.gametest` | fabric (gametest) | PanicGameTest, PolledEventsStressGameTest, SmokeGameTest, StareGameTest |  |
